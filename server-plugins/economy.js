...
function getShopDisplay(shop) {
	let display = "<center><font size="4"><b><u>Santa Shop</u><b></font></center><br><div' + (!this.isOfficial ? ' class=infobox-limited' : '') + '><table style='background: #FFF; border-color: #000; border-radius: 6px' border='1' cellspacing='0' cellpadding='5' width='100%'>" +
	...
	while (start < shop.length) {
		display += "<tr>" +
			"<td align='center'><button name='send' style='background: rgb(210, 237, 249); border-radius: 4px; border: solid, 1px, #000; font-size: 11px; padding: 5px 10px' value='/buy " + shop[start][0] + "'><font color=#000 face=courier><strong>" + shop[start][0] + "</strong></font></button>" + "</td>" +
...
exports.commands = {
	...
	givesnowball: 'givemoney',
	givesnowballs: 'givemoney',
	...
	takesnowball: 'takemoney',
	takesnowballs: 'takemoney',
	takebucks: 'takemoney',
	...
	transfersnowball: 'transfermoney',
	transfersnowballs: 'transfermoney',
	...
	resetsnowball: 'resetmoney',
	resetsnowballs: 'resetmoney',
